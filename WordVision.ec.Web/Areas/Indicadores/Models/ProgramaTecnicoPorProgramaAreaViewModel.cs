...
{
    public class ProgramaTecnicoPorProgramaAreaViewModel : IEquatable<ProgramaTecnicoPorProgramaAreaViewModel>
    {
        ...
        public bool Equals(ProgramaTecnicoPorProgramaAreaViewModel other)
        {
