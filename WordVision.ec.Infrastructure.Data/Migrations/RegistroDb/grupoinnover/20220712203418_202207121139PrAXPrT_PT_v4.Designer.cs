...
namespace WordVision.ec.Infrastructure.Data.Migrations.RegistroDb.grupoinnover
{
    ...
    [Migration("20220712203418_202207121139PrAXPrT_PT_v4")]
    partial class _202207121139PrAXPrT_PT_v4
    {
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Indicadores.ProyectoTecnicoPorProgramaArea", b =>
                {
                    ...
                    b.Property<int?>("ProgramaTecnicoId")
                        .HasColumnType("int");

                    b.Property<int?>("programaAreaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProgramaTecnicoId");

                    b.HasIndex("programaAreaId");
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Indicadores.FaseProgramaArea", b =>
                {
                    ...
                    b.HasOne("WordVision.ec.Domain.Entities.Maestro.ProgramaTecnico", "ProyectoTecnico")
                        .WithMany()
            ...
            modelBuilder.Entity("WordVision.ec.Domain.Entities.Indicadores.ProyectoTecnicoPorProgramaArea", b =>
                {
                    ...
                    b.HasOne("WordVision.ec.Domain.Entities.Maestro.ProgramaTecnico", "ProgramaTecnico")
                        .WithMany()
                        .HasForeignKey("ProgramaTecnicoId");

                    b.HasOne("WordVision.ec.Domain.Entities.Maestro.ProgramaArea", "programaArea")
                        .WithMany()
                        .HasForeignKey("programaAreaId");
