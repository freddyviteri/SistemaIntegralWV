...
namespace WordVision.ec.Application.Features.Indicadores.ProgramaTecnicoPorProgramaArea
{
    public class ProgramaTecnicoPorProgramaAreaResponse : GenericResponse
    {
